...
export const InputSearch = ({placeholder, label, onChange}:InputSearchProps) => {
  ...
  return (
    <>
      <fieldset className="space-y-1 border rounded-md w-[60%] ">
        ...
        <div className="relative w-full">
          ...
          <input onChange={onChange} type="search" name="Search" placeholder={placeholder} className="w-full py-2 pl-14 pr-2 text-sm rounded-md focus:outline-none focus:text-brand-secondary" />
        </div>
        </fieldset>
    </>
  )
